...
| <a name="input_ip_allocation_strategy"></a> [ip\_allocation\_strategy](#input\_ip\_allocation\_strategy) | The IP allocation strategy of AWS VPC CNI, Ref: https://github.com/aws/amazon-vpc-cni-k8s/blob/master/README.md | <pre>object({<br/>    warm_eni_target    = optional(string, null)<br/>    warm_prefix_target = optional(string, null)<br/>    warm_ip_target     = optional(string, null)<br/>    minimum_ip_target  = optional(string, null)<br/>  })</pre> | <pre>{<br/>  "minimum_ip_target": "5",<br/>  "warm_eni_target": null,<br/>  "warm_ip_target": "3",<br/>  "warm_prefix_target": null<br/>}</pre> | no |
