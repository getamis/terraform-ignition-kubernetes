...
| <a name="input_node_cidr_mask_size"></a> [node\_cidr\_mask\_size](#input\_node\_cidr\_mask\_size) | (Optional)[cilium-vxlan] Mask size for node cidr in cluster. | `number` | `23` | no |
